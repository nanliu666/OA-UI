...
<mg-input v-model="input" placeholder="请输入内容"></mg-input>
...
```html
<mg-input placeholder="请输入密码" v-model="input" show-password></mg-input>
...
```html
<div>
  <mg-input placeholder="请输入内容" v-model="input1">
    <template slot="prepend">Http://</template>
  </mg-input>
</div>
<div style="margin-top: 15px;">
  <mg-input placeholder="请输入内容" v-model="input2">
    <template slot="append">.com</template>
  </mg-input>
</div>
<div style="margin-top: 15px;">
  <mg-input placeholder="请输入内容" v-model="input3" class="input-with-select">
...
<style>
  ...
  .input-with-select .mg-input-group__prepend {
